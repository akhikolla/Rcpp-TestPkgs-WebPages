...
TEST(,){
  ...
  std::string init_pop_size_t = "/home/akhila/fuzzer_packages/fuzzedpackages/impactflu/inst/testfiles/method1_cpp/libFuzzer_method1_cpp/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_init_pop_size.qs";
  ...
  std::string vaccinations_t = "/home/akhila/fuzzer_packages/fuzzedpackages/impactflu/inst/testfiles/method1_cpp/libFuzzer_method1_cpp/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_vaccinations.qs";
  ...
  std::string cases_t = "/home/akhila/fuzzer_packages/fuzzedpackages/impactflu/inst/testfiles/method1_cpp/libFuzzer_method1_cpp/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_cases.qs";
  qs::c_qsave(cases,cases_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "cases values: "<< cases << std::endl;
  NumericVector ve  = RcppDeepState_NumericVector();
  std::string ve_t = "/home/akhila/fuzzer_packages/fuzzedpackages/impactflu/inst/testfiles/method1_cpp/libFuzzer_method1_cpp/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_ve.qs";
  qs::c_qsave(ve,ve_t,
		"high", "zstd", 1, 15, true, 1);

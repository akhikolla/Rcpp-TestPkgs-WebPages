...
TEST(,){
  ...
  qs::c_qsave(init_pop_size,"/home/akhila/fuzzer_packages/fuzzedpackages/impactflu/inst/testfiles/method3_cpp/inputs/init_pop_size.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "init_pop_size values: "<< init_pop_size << std::endl;
  IntegerVector vaccinations  = RcppDeepState_IntegerVector();
  qs::c_qsave(vaccinations,"/home/akhila/fuzzer_packages/fuzzedpackages/impactflu/inst/testfiles/method3_cpp/inputs/vaccinations.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "vaccinations values: "<< vaccinations << std::endl;
  IntegerVector cases  = RcppDeepState_IntegerVector();
  qs::c_qsave(cases,"/home/akhila/fuzzer_packages/fuzzedpackages/impactflu/inst/testfiles/method3_cpp/inputs/cases.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "cases values: "<< cases << std::endl;
  NumericVector ve  = RcppDeepState_NumericVector();
  qs::c_qsave(ve,"/home/akhila/fuzzer_packages/fuzzedpackages/impactflu/inst/testfiles/method3_cpp/inputs/ve.qs",
		"high", "zstd", 1, 15, true, 1);

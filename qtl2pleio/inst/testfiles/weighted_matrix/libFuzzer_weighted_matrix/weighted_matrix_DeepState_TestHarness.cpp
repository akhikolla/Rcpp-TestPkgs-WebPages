...
TEST(,){
  ...
  std::string mat_t = "/home/akhila/fuzzer_packages/fuzzedpackages/qtl2pleio/inst/testfiles/weighted_matrix/libFuzzer_weighted_matrix/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_mat.qs";
  qs::c_qsave(mat,mat_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "mat values: "<< mat << std::endl;
  NumericVector weights  = RcppDeepState_NumericVector();
  std::string weights_t = "/home/akhila/fuzzer_packages/fuzzedpackages/qtl2pleio/inst/testfiles/weighted_matrix/libFuzzer_weighted_matrix/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_weights.qs";

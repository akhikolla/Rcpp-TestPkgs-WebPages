...
TEST(,){
  ...
  qs::c_qsave(array,"/home/akhila/fuzzer_packages/fuzzedpackages/qtl2pleio/inst/testfiles/weighted_3darray/inputs/array.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "array values: "<< array << std::endl;
  NumericVector weights  = RcppDeepState_NumericVector();
  qs::c_qsave(weights,"/home/akhila/fuzzer_packages/fuzzedpackages/qtl2pleio/inst/testfiles/weighted_3darray/inputs/weights.qs",
		"high", "zstd", 1, 15, true, 1);

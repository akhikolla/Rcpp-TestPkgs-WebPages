...
TEST(,){
  ...
  qs::c_qsave(X,"/home/akhila/fuzzer_packages/fuzzedpackages/qtl2pleio/inst/testfiles/matrix_x_3darray/inputs/X.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "X values: "<< X << std::endl;
  NumericVector A  = RcppDeepState_NumericVector();
  qs::c_qsave(A,"/home/akhila/fuzzer_packages/fuzzedpackages/qtl2pleio/inst/testfiles/matrix_x_3darray/inputs/A.qs",
		"high", "zstd", 1, 15, true, 1);

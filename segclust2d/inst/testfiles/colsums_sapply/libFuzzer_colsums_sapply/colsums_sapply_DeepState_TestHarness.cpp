...
TEST(,){
  ...
  std::string i_t = "/home/akhila/fuzzer_packages/fuzzedpackages/segclust2d/inst/testfiles/colsums_sapply/libFuzzer_colsums_sapply/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_i.qs";
  qs::c_qsave(i,i_t,

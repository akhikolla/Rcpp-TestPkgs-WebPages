...
TEST(,){
  ...
  qs::c_qsave(mtx,"/home/akhila/fuzzer_packages/fuzzedpackages/maxnodf/inst/testfiles/hill_climb_step_cpp/inputs/mtx.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "mtx values: "<< mtx << std::endl;
  IntegerVector R(1);
  R[0]  = RcppDeepState_int();
  qs::c_qsave(R,"/home/akhila/fuzzer_packages/fuzzedpackages/maxnodf/inst/testfiles/hill_climb_step_cpp/inputs/R.qs",
		"high", "zstd", 1, 15, true, 1);

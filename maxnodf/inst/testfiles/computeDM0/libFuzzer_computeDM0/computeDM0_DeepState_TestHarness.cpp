...
TEST(,){
  ...
  std::string mtx_t = "/home/akhila/fuzzer_packages/fuzzedpackages/maxnodf/inst/testfiles/computeDM0/libFuzzer_computeDM0/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_mtx.qs";

...
TEST(,){
  ...
  qs::c_qsave(uev,"/home/akhila/fuzzer_packages/fuzzedpackages/kdecopula/inst/testfiles/inv_hfunc/inputs/uev.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "uev values: "<< uev << std::endl;
  IntegerVector cond_var(1);
  cond_var[0]  = RcppDeepState_int();
  qs::c_qsave(cond_var,"/home/akhila/fuzzer_packages/fuzzedpackages/kdecopula/inst/testfiles/inv_hfunc/inputs/cond_var.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "cond_var values: "<< cond_var << std::endl;
  NumericMatrix vals  = RcppDeepState_NumericMatrix();
  qs::c_qsave(vals,"/home/akhila/fuzzer_packages/fuzzedpackages/kdecopula/inst/testfiles/inv_hfunc/inputs/vals.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "vals values: "<< vals << std::endl;
  NumericVector grid  = RcppDeepState_NumericVector();
  qs::c_qsave(grid,"/home/akhila/fuzzer_packages/fuzzedpackages/kdecopula/inst/testfiles/inv_hfunc/inputs/grid.qs",
		"high", "zstd", 1, 15, true, 1);

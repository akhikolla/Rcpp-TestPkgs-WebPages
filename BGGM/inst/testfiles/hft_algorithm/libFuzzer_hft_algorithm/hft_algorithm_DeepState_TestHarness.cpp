...
TEST(,){
  ...
  std::string tol_t = "/home/akhila/fuzzer_packages/fuzzedpackages/BGGM/inst/testfiles/hft_algorithm/libFuzzer_hft_algorithm/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_tol.qs";
  ...
  std::string max_iter_t = "/home/akhila/fuzzer_packages/fuzzedpackages/BGGM/inst/testfiles/hft_algorithm/libFuzzer_hft_algorithm/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_max_iter.qs";

...
TEST(,){
  ...
  std::string n_t = "/home/akhila/fuzzer_packages/fuzzedpackages/surbayes/inst/testfiles/fastKronEye_Y/libFuzzer_fastKronEye_Y/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_n.qs";
  qs::c_qsave(n,n_t,
  ...
  std::string J_t = "/home/akhila/fuzzer_packages/fuzzedpackages/surbayes/inst/testfiles/fastKronEye_Y/libFuzzer_fastKronEye_Y/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_J.qs";
  qs::c_qsave(J,J_t,
		"high", "zstd", 1, 15, true, 1);

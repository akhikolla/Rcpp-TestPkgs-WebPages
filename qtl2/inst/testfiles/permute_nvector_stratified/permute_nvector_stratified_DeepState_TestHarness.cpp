...
TEST(,){
  ...
  qs::c_qsave(n_perm,"/home/akhila/fuzzer_packages/fuzzedpackages/qtl2/inst/testfiles/permute_nvector_stratified/inputs/n_perm.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "n_perm values: "<< n_perm << std::endl;
  NumericVector x  = RcppDeepState_NumericVector();
  qs::c_qsave(x,"/home/akhila/fuzzer_packages/fuzzedpackages/qtl2/inst/testfiles/permute_nvector_stratified/inputs/x.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "x values: "<< x << std::endl;
  IntegerVector strata  = RcppDeepState_IntegerVector();
  qs::c_qsave(strata,"/home/akhila/fuzzer_packages/fuzzedpackages/qtl2/inst/testfiles/permute_nvector_stratified/inputs/strata.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "strata values: "<< strata << std::endl;
  IntegerVector n_strata(1);
  n_strata[0]  = RcppDeepState_int();
  qs::c_qsave(n_strata,"/home/akhila/fuzzer_packages/fuzzedpackages/qtl2/inst/testfiles/permute_nvector_stratified/inputs/n_strata.qs",
		"high", "zstd", 1, 15, true, 1);

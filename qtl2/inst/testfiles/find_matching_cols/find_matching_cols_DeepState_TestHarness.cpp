...
TEST(,){
  ...
  qs::c_qsave(mat,"/home/akhila/fuzzer_packages/fuzzedpackages/qtl2/inst/testfiles/find_matching_cols/inputs/mat.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "mat values: "<< mat << std::endl;
  NumericVector tol(1);
  tol[0]  = RcppDeepState_double();
  qs::c_qsave(tol,"/home/akhila/fuzzer_packages/fuzzedpackages/qtl2/inst/testfiles/find_matching_cols/inputs/tol.qs",
		"high", "zstd", 1, 15, true, 1);

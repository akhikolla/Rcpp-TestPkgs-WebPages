...
TEST(,){
  ...
  std::string mat_t = "/home/akhila/fuzzer_packages/fuzzedpackages/qtl2/inst/testfiles/find_matching_cols/libFuzzer_find_matching_cols/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_mat.qs";
  ...
  std::string tol_t = "/home/akhila/fuzzer_packages/fuzzedpackages/qtl2/inst/testfiles/find_matching_cols/libFuzzer_find_matching_cols/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_tol.qs";

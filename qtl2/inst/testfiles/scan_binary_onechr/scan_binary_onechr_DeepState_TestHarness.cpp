...
TEST(,){
  ...
  qs::c_qsave(genoprobs,"/home/akhila/fuzzer_packages/fuzzedpackages/qtl2/inst/testfiles/scan_binary_onechr/inputs/genoprobs.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "genoprobs values: "<< genoprobs << std::endl;
  NumericMatrix pheno  = RcppDeepState_NumericMatrix();
  qs::c_qsave(pheno,"/home/akhila/fuzzer_packages/fuzzedpackages/qtl2/inst/testfiles/scan_binary_onechr/inputs/pheno.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "pheno values: "<< pheno << std::endl;
  NumericMatrix addcovar  = RcppDeepState_NumericMatrix();
  qs::c_qsave(addcovar,"/home/akhila/fuzzer_packages/fuzzedpackages/qtl2/inst/testfiles/scan_binary_onechr/inputs/addcovar.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "addcovar values: "<< addcovar << std::endl;
  IntegerVector maxit(1);
  maxit[0]  = RcppDeepState_int();
  qs::c_qsave(maxit,"/home/akhila/fuzzer_packages/fuzzedpackages/qtl2/inst/testfiles/scan_binary_onechr/inputs/maxit.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "maxit values: "<< maxit << std::endl;
  NumericVector tol(1);
  tol[0]  = RcppDeepState_double();
  qs::c_qsave(tol,"/home/akhila/fuzzer_packages/fuzzedpackages/qtl2/inst/testfiles/scan_binary_onechr/inputs/tol.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "tol values: "<< tol << std::endl;
  NumericVector qr_tol(1);
  qr_tol[0]  = RcppDeepState_double();
  qs::c_qsave(qr_tol,"/home/akhila/fuzzer_packages/fuzzedpackages/qtl2/inst/testfiles/scan_binary_onechr/inputs/qr_tol.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "qr_tol values: "<< qr_tol << std::endl;
  NumericVector eta_max(1);
  eta_max[0]  = RcppDeepState_double();
  qs::c_qsave(eta_max,"/home/akhila/fuzzer_packages/fuzzedpackages/qtl2/inst/testfiles/scan_binary_onechr/inputs/eta_max.qs",
		"high", "zstd", 1, 15, true, 1);

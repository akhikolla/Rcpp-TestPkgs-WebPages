...
TEST(,){
  ...
  std::string array_t = "/home/akhila/fuzzer_packages/fuzzedpackages/qtl2/inst/testfiles/weighted_3darray/libFuzzer_weighted_3darray/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_array.qs";
  qs::c_qsave(array,array_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "array values: "<< array << std::endl;
  NumericVector weights  = RcppDeepState_NumericVector();
  std::string weights_t = "/home/akhila/fuzzer_packages/fuzzedpackages/qtl2/inst/testfiles/weighted_3darray/libFuzzer_weighted_3darray/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_weights.qs";

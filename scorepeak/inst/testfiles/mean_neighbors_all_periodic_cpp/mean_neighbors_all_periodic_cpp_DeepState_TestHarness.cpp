...
TEST(,){
  ...
  qs::c_qsave(data,"/home/akhila/fuzzer_packages/fuzzedpackages/scorepeak/inst/testfiles/mean_neighbors_all_periodic_cpp/inputs/data.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "data values: "<< data << std::endl;
  IntegerVector windowsize(1);
  windowsize[0]  = RcppDeepState_int();
  qs::c_qsave(windowsize,"/home/akhila/fuzzer_packages/fuzzedpackages/scorepeak/inst/testfiles/mean_neighbors_all_periodic_cpp/inputs/windowsize.qs",
		"high", "zstd", 1, 15, true, 1);

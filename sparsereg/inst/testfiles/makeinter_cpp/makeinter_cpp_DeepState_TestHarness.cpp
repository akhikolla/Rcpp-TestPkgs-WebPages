...
TEST(,){
  ...
  qs::c_qsave(X00,"/home/akhila/fuzzer_packages/fuzzedpackages/sparsereg/inst/testfiles/makeinter_cpp/inputs/X00.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "X00 values: "<< X00 << std::endl;
  NumericVector X10  = RcppDeepState_NumericVector();
  qs::c_qsave(X10,"/home/akhila/fuzzer_packages/fuzzedpackages/sparsereg/inst/testfiles/makeinter_cpp/inputs/X10.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "X10 values: "<< X10 << std::endl;
  NumericVector X20  = RcppDeepState_NumericVector();
  qs::c_qsave(X20,"/home/akhila/fuzzer_packages/fuzzedpackages/sparsereg/inst/testfiles/makeinter_cpp/inputs/X20.qs",
		"high", "zstd", 1, 15, true, 1);

...
TEST(,){
  ...
  qs::c_qsave(nt,"/home/akhila/fuzzer_packages/fuzzedpackages/sommer/inst/testfiles/scorecalc/inputs/nt.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "nt values: "<< nt << std::endl;
  NumericVector minMAF(1);
  minMAF[0]  = RcppDeepState_double();
  qs::c_qsave(minMAF,"/home/akhila/fuzzer_packages/fuzzedpackages/sommer/inst/testfiles/scorecalc/inputs/minMAF.qs",
		"high", "zstd", 1, 15, true, 1);

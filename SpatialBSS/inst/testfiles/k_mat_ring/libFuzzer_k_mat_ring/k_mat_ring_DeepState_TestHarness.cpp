...
TEST(,){
  ...
  std::string h1_t = "/home/akhila/fuzzer_packages/fuzzedpackages/SpatialBSS/inst/testfiles/k_mat_ring/libFuzzer_k_mat_ring/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_h1.qs";
  qs::c_qsave(h1,h1_t,
  ...
  std::string h2_t = "/home/akhila/fuzzer_packages/fuzzedpackages/SpatialBSS/inst/testfiles/k_mat_ring/libFuzzer_k_mat_ring/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_h2.qs";
  qs::c_qsave(h2,h2_t,
		"high", "zstd", 1, 15, true, 1);
